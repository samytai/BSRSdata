...
mydata=mydata[['SuicidIdea','bsrs1','bsrs2','bsrs3','bsrs4','bsrs5','group','age','sex']]
print(mydata.head())
...
train_x=trainData[['bsrs1','bsrs2','bsrs3','bsrs4','bsrs5','age','sex']]
train_y=trainData[['SuicidIdea']]

val_x=valData[['bsrs1','bsrs2','bsrs3','bsrs4','bsrs5','age','sex']]
val_y=valData[['SuicidIdea']]

test_x=testData[['bsrs1','bsrs2','bsrs3','bsrs4','bsrs5','age','sex']]
...
model=Sequential()
model.add(Dense(units=50,input_dim=7,activation='relu'))
...
train_history=model.fit(x=train_x,y=train_y,epochs=20,batch_size=200,verbose=2,validation_data=(val_x,val_y),callbacks=[myEarlyStopping])
#train_history=model.fit(x=train_x,y=train_y,epochs=20,batch_size=200,verbose=2,validation_data=(val_x,val_y))
